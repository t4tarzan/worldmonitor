  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      <div class="header">
        ...
        const local = this.ctx.isDesktopApp || location.hostname === 'localhost' || location.hostname === '127.0.0.1' || location.hostname.endsWith('.vercel.app');
        // 'local' variant has no subdomain, always use # and JS click handler
        const vHref = (v: string, prod: string) => local || SITE_VARIANT === v || v === 'local' ? '#' : prod;
        ...
        return `
          ...
          <a href="/landing.html" class="get-monitor-btn" title="Get your own WorldMonitor instance">
            <span>Get My Monitor</span>
          </a>
          <a href="https://github.com/t4tarzan/worldmonitor" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
        ...
        : '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/></svg>'}
          ...
          <span id="presence-bar-mount" style="display:contents"></span>
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <a class="mobile-menu-item" href="/landing.html">
          <span class="mobile-menu-item-icon">🚀</span>
          <span class="mobile-menu-item-label">Get My Monitor</span>
        </a>
        <div class="mobile-menu-divider"></div>
