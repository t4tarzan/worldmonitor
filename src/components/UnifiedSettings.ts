...
const DESKTOP_RELEASES_URL = 'https://github.com/t4tarzan/worldmonitor/releases';
...
export class UnifiedSettings {
  ...
  private renderGeneralContent(): string {
    ...
    html += `<a href="https://github.com/t4tarzan/worldmonitor/discussions" target="_blank" rel="noopener" class="us-discussion-link">
